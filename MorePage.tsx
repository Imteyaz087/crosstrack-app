...
import { ShoppingCart, BarChart3, Settings, ChevronRight, Timer, Calculator, BookOpen, Target, Trophy, ChefHat, Dumbbell, Brain, Cloud, Camera, Heart, History, Ruler, CalendarDays, Award, Shield, HelpCircle } from 'lucide-react'
...
type SubPage = 'menu' | 'grocery' | 'progress' | 'settings' | 'timer' | 'calc' | 'benchmarks' | 'movementPRs' | 'achievements' | 'wodTemplates' | 'mealPrep' | 'aiCoach' | 'cloudSync' | 'photoLog' | 'heartRate' | 'workoutHistory' | 'bodyMeasurements' | 'weeklyPlanner' | 'prWall' | 'privacy' | 'support'
