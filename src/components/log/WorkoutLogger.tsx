...
export function WorkoutLogger({
  ...
  return (
    <div className="space-y-4 w-full overflow-hidden">
      ...
      {hasWod && (
        <>
          <div className={`bg-gradient-to-b from-cyan-500/5 to-ct-surface/40 rounded-ct-lg p-4 border border-cyan-400/15 space-y-4 ${hasStrength ? 'mt-6 shadow-[0_-10px_24px_rgba(6,182,212,0.05)]' : ''}`}>
