...
1. Read `TRACKVOLT_BRAIN.md` (this file)
2. Read `AGENTS.md` for agent-specific rules
3. Read `AI_SYNC/CLAUDE_SYNC.md` or `CODEX_SYNC.md` depending on which agent you are
4. Check `FINDINGS/` for any claims or pending work
